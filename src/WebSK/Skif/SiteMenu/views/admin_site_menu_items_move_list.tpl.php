...
$site_menu_move_item_obj = $site_menu_item_service->getById($move_item_id);
?>
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            <td>
                <?php
                if ($parent_id) {
                    $site_menu_parent_item_obj = $site_menu_item_service->getById($parent_id);
                    ?>
        ...
        foreach ($site_menu_item_ids_arr as $site_menu_item_id) {
            ...
            $children_ids_arr = $site_menu_item_service->getChildrenIdsArr();
            ?>
            <tr>
