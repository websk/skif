    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-striped table-hover">
                <colgroup>
                    <col class="col-md-9 col-sm-7 col-xs-7">
                ...
                foreach ($blocks_ids_arr as $block_id) {
                    ...
                    echo '<tr>';
                    echo '<td>' . $block_obj->getId() . '. ';
                    echo '<a href="' . $block_obj->getEditorUrl() . '">' . $block_obj->getTitle() . '</td>';
                    if ($page_region_id != Block::BLOCK_REGION_NONE) {
                        ...
                        <td align="right">
                            ...
                            <a href="/admin/blocks?a=disable&amp;block_id=<?php echo $block_obj->getId(); ?>"
                               title="Отключить" class="btn btn-outline btn-default btn-sm">
