...
$label_field_name = CRUDUtils::getTitleForField($model_class_name, $fast_create_field_name);
...
<form role="form" method="post" class="form" action="<?php echo $create_url; ?>">
    <div class="form-group">
        ...
        <?php
        echo \WebSK\Skif\CRUD\Widgets::renderFieldWithWidget($fast_create_field_name, $obj);
