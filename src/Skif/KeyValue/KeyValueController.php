...
class KeyValueController extends \Skif\CRUD\CRUDController
{
    ...
    protected static function createValidation()
    {
        ...
        if (!preg_match("/^[a-zA-Z0-9_-]+$/", $name)) {
            \Websk\Skif\Messages::setError('Неверное название параметра. Название должно состоять только из латинских букв <code>A-Za-z</code>, цифр <code>0-9</code>, тире <code>-</code> или подчёркивания <code>_</code>');
