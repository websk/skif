...
foreach ($poll_question_ids_arr as $poll_question_id) {
    ...
    <div>
        ...
        <div>
            <div class="progress">
                <div class="progress-bar<?php echo ($poll_question_obj->getVotes() == $max ? ' progress-bar-success' : '') ?>" role="progressbar" aria-valuenow="<?php echo $vote_percentage; ?>"
...
?>
<p class="bs-callout bs-callout-info">Всего проголосовало: <?php echo $sum; ?> человек.</p>
