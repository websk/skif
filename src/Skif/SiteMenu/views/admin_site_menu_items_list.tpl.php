    ...
    <tr>
        ...
        <td>
            ...
            if ($site_menu_item_obj->getChildrenIdsArr()) {
                ...
                echo $site_menu_item_obj->getName() . ' <a href="/admin/site_menu/' . $site_menu_id . '/item/edit/new"><span class="glyphicon glyphicon-plus" title="Добавить вложенный пункт"></span></a>';
            }
            ?>
        </td>
        <td align="right">
            <a href="/admin/site_menu/<?php echo $site_menu_id; ?>/item/edit/<?php echo $site_menu_item_id; ?>"><span class="glyphicon glyphicon-edit" title="Редактировать"></span></a>&nbsp;
            <?php
        ...
        <td align="right">
            <a href="/admin/site_menu/<?php echo $site_menu_id; ?>/items/list_for_move/<?php echo $parent_id; ?>?move_item_id=<?php echo $site_menu_item_id; ?>"><span class="glyphicon glyphicon-move" title="Переместить"></span></a>
            <a href="/admin/site_menu/<?php echo $site_menu_id; ?>/item/delete/<?php echo $site_menu_item_id; ?>" onClick="return confirm('Вы уверены, что хотите удалить?')"><span class="glyphicon glyphicon-remove" title="Удалить"></span></a>
        </td>
    </tr>
<?php
    $counter_item++;
